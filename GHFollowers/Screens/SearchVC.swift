...
class SearchVC: UIViewController {
    ...
    let usernameTextField = GFTextField(placeholder: "Enter your username", returnKeyType: .go, autocapitalizationType: .none)
    ...
    @objc func createDismissKeyboard() {
    ...
    @objc func pushFollowersListVC() {
        guard isUsernameEntered else {
            self.presentGFAlertOnMainThread(title: "Empty username", message: "Please enter the username. We need to know who to look for 😆", buttonTitle: "Ok")
            return
        }
